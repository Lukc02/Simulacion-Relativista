! es siguiente modulo estaa comentado para que se use siempre el modulo precision_90
...
! !
! integer, parameter :: wp = selected_real_kind(16,50)
! 
...
!          see main doc for contact details
!
!use rksuite_90_prec, only:wp        ! se usa el siguiente
use rksuite_90_prec
!use precision_90 , only:wp
implicit none
